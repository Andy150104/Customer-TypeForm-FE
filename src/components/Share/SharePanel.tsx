    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <span className={`hidden h-6 w-px sm:block ${isDarkMode ? "bg-slate-800" : "bg-slate-200"}`} />
          <Input
            value={shareUrl}
            readOnly
            className={`min-w-[240px] flex-1 rounded-full border ${
              isDarkMode ? "border-slate-700 bg-slate-950 text-slate-200" : "border-slate-200 bg-white"
            }`}
          />
          <span className={`hidden h-6 w-px sm:block ${isDarkMode ? "bg-slate-800" : "bg-slate-200"}`} />
          <Button
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
            <div className="flex items-center justify-between">
              ...
              <span
                className={`flex h-9 w-9 items-center justify-center rounded-full border ${
                  isDarkMode ? "border-slate-700 text-slate-200" : "border-slate-200 text-slate-600"
                }`}
              >
                <SelectedShareIcon />
              </span>
            ...
            {selectedShare.key === "qr" && (
              <div className="mt-3 flex flex-col items-center gap-3 rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-6">
                <QRCode value={shareUrl} size={168} />
                <span className="text-xs text-slate-500">Scan to open the form.</span>
              </div>
            )}
